...
x_range = [ (center(1)-floor(aa_size(1)/2)) (center(1)+floor(aa_size(1)/2))];
y_range = [ (center(2)-floor(aa_size(2)/2)) (center(2)+floor(aa_size(2)/2))];
...
[metric] = dose_obj ( model_D, MRTI_D);